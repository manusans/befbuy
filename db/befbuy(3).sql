...
--
-- Host: 127.0.0.1
-- Creato il: Feb 28, 2018 alle 16:56
...
CREATE TABLE `product` (
  ...
  `bef_prd_name` varchar(30) NOT NULL,
...
(2, 'Nike Air Force 1 Mid ''07', 'La leggenda continua a vivere nella scarpa Nike Air Force 1 Mid ''07 - Uomo, versione attuale dell''icona che unisce stile classico e dettagli up-to-date.\r\n\r\nColore mostrato in foto: Nero/Nero/Nero\r\nStile: 315123-001', 6),
(3, 'NAPAPIJRI, Giacca Uomo', '\r\n    Rivenditore autorizzato NAPAPIJRI originale Rainforest. \r\n\r\n100% Poliammide\r\nChiusura: Cerniera\r\nLavaggio in lavatrice 30°C\r\nStile scollo: Con cappuccio\r\nManica lunga\r\n\r\ncirconferenza torace cm120 Lunghezza cm 73\r\nLe altre taglie hanno una differenza di circa 2 cm.\r\nFoderato in caldo Pile imbottito\r\n\r\n', 6),
(4, 'DESIGUAL GENOVA RETRO FLASH ', 'Una meravigliosa borsa desigual.', 6);
...
(3, 'great!', 'Shipped very quickly. Shoes true to size. Look great with shorts.', 5, 2);
...
--
ALTER TABLE `product`
  MODIFY `bef_prd_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `review`
  MODIFY `bef_rev_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
